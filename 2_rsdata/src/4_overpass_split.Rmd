...
#Read in data
wqp.pull <- read_feather('D:/Dropbox/projects/riverTSS/2_rsdata/out/wide_pull.feather') %>%
  arrange(lat,long)
#Nest data per site
wqp.nest <- wqp.pull %>%
  ...
  #change to date_utc for new join
  mutate(date_unity=as.character(date_unity))
#Define a function to split data into sub 5000 sized chunks
data.splitter <- function(wqp.nest,dir='D:/Dropbox/projects/riverTSS/2_rsdata/out/split_wide/'){
...
data.splitter(wqp.nest,dir='D:/Dropbox/projects/riverTSS/2_rsdata/out/split_wide/')
