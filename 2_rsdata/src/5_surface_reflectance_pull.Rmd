...
#install.packages(c("feather", "reticulate", "googledrive", "devtools"))
...
#reticulate_python <- 'C:/Users/sntopp/AppData/Local/Continuum/Anaconda2/envs/EarthEngine/python.exe'

#reticulate_python <- 'C:/Users/john/Anaconda2/envs/watersat/python.exe'
#reticulate_python <- 'C:/Users/john/Anaconda2/envs/watersattest/python.exe'
...
##repl_python basically starts a python bash window within your R chunk.  
```
...
#For when Rstudio doesn't want to talk to EE and you need to run it in spyder
#execfile('C:/Users/sntopp/Google Drive/gits/Aquasat/2_rsdata/src/GEE_pull_functions.py')
...
# filesNew <- drive_ls('WQP_SR_MatchUps_dswe')
# for(i in 1:nrow(filesNew)) {
#   path = paste0(getwd(),'/2_rsdata/out/sr_matchups_dswe/', filesNew$name[i])
